...
const Thumb = (
    ...
    const backgroundColor: Animated.AnimatedInterpolation<string> =
        backgroundColorRaw.interpolate({
            inputRange: [0, 1, 2],
            outputRange: [thumbColor.base, thumbColor.hover, thumbColor.press],
        });
    ...
    }, [isActive, trackHover, thumbHover, opacity, useNativeDriver]);
    ...
    }, [drag, thumbHover, useNativeDriver, backgroundColorRaw]);
